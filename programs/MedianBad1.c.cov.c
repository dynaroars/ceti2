...
void __globinit_MedianBad1(void) ;
void *_coverage_fout ;
/* compiler builtin: 
...
{ 
  ...
  {
  __globinit_MedianBad1();
  fprintf(_coverage_fout, "0\n");
  fflush(_coverage_fout);
  tmp = atoi(*(argv + 3));
  tmp___0 = atoi(*(argv + 2));
  tmp___1 = atoi(*(argv + 1));
  mainQ(tmp___1, tmp___0, tmp);
...
{ 
  ...
  {
  _coverage_fout = fopen("programs/MedianBad1.c.cov.c.path", "ab");
}
}
